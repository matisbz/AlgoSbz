...
STRATEGIES = {
    ...
    "MACDhist": {
        "module": "algosbz.strategy.macd_histogram",
        "class": "MACDHistogram",
        "presets": {
            "default_H4": {"timeframe": "H4"},
            "default_H1": {"timeframe": "H1"},
            "wideR_H4": {"timeframe": "H4", "sl_atr_mult": 2.0, "tp_atr_mult": 5.0, "hist_threshold_atr": 0.3},
            "wideR_H1": {"timeframe": "H1", "sl_atr_mult": 2.0, "tp_atr_mult": 5.0, "hist_threshold_atr": 0.3},
            "trend_H4": {"timeframe": "H4", "adx_min": 20, "sl_atr_mult": 2.5, "tp_atr_mult": 6.0, "hist_threshold_atr": 0.4},
            "fast_H4": {"timeframe": "H4", "macd_fast": 8, "macd_slow": 17, "macd_signal": 9, "sl_atr_mult": 2.0, "tp_atr_mult": 4.5},
            "slow_H4": {"timeframe": "H4", "macd_fast": 16, "macd_slow": 36, "macd_signal": 9, "sl_atr_mult": 2.5, "tp_atr_mult": 5.5},
        },
    },
    "StochRev": {
        "module": "algosbz.strategy.stochastic_reversal",
        "class": "StochasticReversal",
        "presets": {
            "default_H4": {"timeframe": "H4"},
            "default_H1": {"timeframe": "H1"},
            "wideR_H4": {"timeframe": "H4", "sl_atr_mult": 2.0, "tp_atr_mult": 5.0},
            "wideR_H1": {"timeframe": "H1", "sl_atr_mult": 2.0, "tp_atr_mult": 5.0},
            "tight_H4": {"timeframe": "H4", "oversold": 15, "overbought": 85, "sl_atr_mult": 2.5, "tp_atr_mult": 5.5},
            "calm_H4": {"timeframe": "H4", "adx_max": 25, "sl_atr_mult": 2.0, "tp_atr_mult": 4.5},
            "fast_H4": {"timeframe": "H4", "k_period": 9, "d_period": 3, "sl_atr_mult": 2.0, "tp_atr_mult": 4.0},
        },
    },
    "CCIext": {
        "module": "algosbz.strategy.cci_extreme",
        "class": "CCIExtreme",
        "presets": {
            "default_H4": {"timeframe": "H4"},
            "default_H1": {"timeframe": "H1"},
            "wideR_H4": {"timeframe": "H4", "sl_atr_mult": 2.0, "tp_atr_mult": 5.0},
            "wideR_H1": {"timeframe": "H1", "sl_atr_mult": 2.0, "tp_atr_mult": 5.0},
            "extreme_H4": {"timeframe": "H4", "cci_extreme": 250, "sl_atr_mult": 2.5, "tp_atr_mult": 5.5},
            "relaxed_H4": {"timeframe": "H4", "cci_extreme": 150, "adx_max": 30, "sl_atr_mult": 2.0, "tp_atr_mult": 4.0},
        },
    },
    "PinBar": {
        "module": "algosbz.strategy.pin_bar",
        ...
        "presets": {
            ...
            "wideR_H4": {"timeframe": "H4", "sl_atr_mult": 2.0, "tp_atr_mult": 5.0},
            "wideR_H1": {"timeframe": "H1", "sl_atr_mult": 2.0, "tp_atr_mult": 5.0},
            "strict_H4": {"timeframe": "H4", "min_wick_ratio": 3.0, "max_body_pct": 0.25, "sl_atr_mult": 2.0, "tp_atr_mult": 5.0},
            "loose_H4": {"timeframe": "H4", "min_wick_ratio": 1.5, "max_body_pct": 0.40, "level_proximity_atr": 0.8},
            "deep_H4": {"timeframe": "H4", "level_lookback": 30, "sl_atr_mult": 2.5, "tp_atr_mult": 5.5},
        },
    },
    "DonTrend": {
        "module": "algosbz.strategy.donchian_trend",
        "class": "DonchianTrend",
        "presets": {
            "default_H4": {"timeframe": "H4"},
            "default_H1": {"timeframe": "H1"},
            "wideR_H4": {"timeframe": "H4", "sl_atr_mult": 2.0, "tp_atr_mult": 5.0},
            "fast_H4": {"timeframe": "H4", "entry_period": 15, "sl_atr_mult": 2.0, "tp_atr_mult": 4.5},
            "slow_H4": {"timeframe": "H4", "entry_period": 30, "sl_atr_mult": 3.0, "tp_atr_mult": 6.0},
            "turtle_H4": {"timeframe": "H4", "entry_period": 20, "max_channel_atr": 4.0, "min_channel_atr": 2.0, "sl_atr_mult": 2.5, "tp_atr_mult": 5.5},
        },
    },
    "ADXbirth": {
        "module": "algosbz.strategy.adx_trend_birth",
        "class": "ADXTrendBirth",
        "presets": {
            "default_H4": {"timeframe": "H4"},
            "default_H1": {"timeframe": "H1"},
            "wideR_H4": {"timeframe": "H4", "sl_atr_mult": 2.0, "tp_atr_mult": 5.0},
            "sensitive_H4": {"timeframe": "H4", "adx_low": 22, "adx_trigger": 22, "lookback_low": 10, "sl_atr_mult": 2.0, "tp_atr_mult": 4.5},
            "strict_H4": {"timeframe": "H4", "adx_low": 18, "adx_trigger": 28, "lookback_low": 8, "sl_atr_mult": 2.5, "tp_atr_mult": 5.5},
            "fast_ema_H4": {"timeframe": "H4", "ema_period": 30, "lookback_low": 10, "sl_atr_mult": 2.0, "tp_atr_mult": 5.0},
            "slow_ema_H4": {"timeframe": "H4", "ema_period": 100, "lookback_low": 10, "sl_atr_mult": 2.5, "tp_atr_mult": 5.5},
        },
    },
}
