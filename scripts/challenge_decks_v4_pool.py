"""79-combo pool from massive_scan v4 (2026-04-08). Used by optimize_deck_v5 only."""
STRAT_REGISTRY = {'VMR': {'module': 'algosbz.strategy.volatility_mean_reversion', 'class': 'VolatilityMeanReversion'},
...
ALL_COMBOS = {
    ...
    "TPB_XTIUSD_wideR_H4": {
        "strat": "TPB", "symbol": "XTIUSD", "tier": "ROBUST", "pf": 1.33,
        "params": {'timeframe': 'H4', 'adx_min': 25, 'pullback_zone_atr': 0.6, 'sl_atr_mult': 2.0, 'tp_atr_mult': 5.0, 'session_start': 0, 'session_end': 23},
    },
    "TPB_XTIUSD_trend_H4": {
        "strat": "TPB", "symbol": "XTIUSD", "tier": "ROBUST", "pf": 1.72,
        "params": {'timeframe': 'H4', 'adx_min': 28, 'sl_atr_mult': 2.5, 'tp_atr_mult': 6.0, 'session_start': 0, 'session_end': 23},
    },
    ...
    "TPB_XTIUSD_loose_H4_ny": {
        "strat": "TPB", "symbol": "XTIUSD", "tier": "ROBUST", "pf": 1.21,
    ...
    "TPB_XTIUSD_trendL_H4": {
        "strat": "TPB", "symbol": "XTIUSD", "tier": "ROBUST", "pf": 1.46,
    ...
    "Engulf_EURUSD_tight_H4": {
        "strat": "Engulf", "symbol": "EURUSD", "tier": "ROBUST", "pf": 1.28,
    ...
    "Engulf_EURUSD_tight_H4_lon": {
        "strat": "Engulf", "symbol": "EURUSD", "tier": "ROBUST", "pf": 1.28,
        "params": {'timeframe': 'H4', 'swing_zone_atr': 0.3, 'min_body_ratio': 0.7, 'tp_atr_mult': 3.0, 'session_start': 7, 'session_end': 16},
    },
    "Engulf_EURUSD_tight_H4_ny": {
        "strat": "Engulf", "symbol": "EURUSD", "tier": "ROBUST", "pf": 1.28,
        "params": {'timeframe': 'H4', 'swing_zone_atr': 0.3, 'min_body_ratio': 0.7, 'tp_atr_mult': 3.0, 'session_start': 12, 'session_end': 21},
    },
    "Engulf_EURUSD_wideR_H4_lon": {
        "strat": "Engulf", "symbol": "EURUSD", "tier": "ROBUST", "pf": 1.36,
        "params": {'timeframe': 'H4', 'swing_zone_atr': 0.4, 'min_body_ratio': 0.7, 'sl_atr_mult': 2.0, 'tp_atr_mult': 5.0, 'session_start': 7, 'session_end': 16},
    },
    "Engulf_EURJPY_wideR_H4_lon": {
        "strat": "Engulf", "symbol": "EURJPY", "tier": "ROBUST", "pf": 1.39,
        "params": {'timeframe': 'H4', 'swing_zone_atr': 0.4, 'min_body_ratio': 0.7, 'sl_atr_mult': 2.0, 'tp_atr_mult': 5.0, 'session_start': 7, 'session_end': 16},
    },
    "Engulf_EURUSD_wideR_H4_ny": {
        "strat": "Engulf", "symbol": "EURUSD", "tier": "ROBUST", "pf": 1.36,
        "params": {'timeframe': 'H4', 'swing_zone_atr': 0.4, 'min_body_ratio': 0.7, 'sl_atr_mult': 2.0, 'tp_atr_mult': 5.0, 'session_start': 12, 'session_end': 21},
    },
    "Engulf_EURJPY_wideR_H4_ny": {
        "strat": "Engulf", "symbol": "EURJPY", "tier": "ROBUST", "pf": 1.39,
        "params": {'timeframe': 'H4', 'swing_zone_atr': 0.4, 'min_body_ratio': 0.7, 'sl_atr_mult': 2.0, 'tp_atr_mult': 5.0, 'session_start': 12, 'session_end': 21},
    },
    ...
    "StrBrk_GBPJPY_wideR_H4_lon": {
        "strat": "StrBrk", "symbol": "GBPJPY", "tier": "ROBUST", "pf": 1.37,
        "params": {'timeframe': 'H4', 'swing_lookback': 6, 'sl_atr_mult': 2.0, 'tp_atr_mult': 5.5, 'session_start': 7, 'session_end': 16},
    },
    "StrBrk_GBPJPY_wideR_H4_ny": {
        "strat": "StrBrk", "symbol": "GBPJPY", "tier": "ROBUST", "pf": 1.37,
        "params": {'timeframe': 'H4', 'swing_lookback': 6, 'sl_atr_mult': 2.0, 'tp_atr_mult': 5.5, 'session_start': 12, 'session_end': 21},
    },
    ...
    "MACross_XAUUSD_wideR_H4_lon": {
        "strat": "MACross", "symbol": "XAUUSD", "tier": "ROBUST", "pf": 1.3,
        "params": {'timeframe': 'H4', 'fast_period': 8, 'slow_period': 21, 'adx_min': 25, 'sl_atr_mult': 2.0, 'tp_atr_mult': 5.0, 'session_start': 7, 'session_end': 16},
    },
    ...
    "TPB_XTIUSD_trend_H4_lon": {
        "strat": "TPB", "symbol": "XTIUSD", "tier": "SPREAD_OK", "pf": 1.46,
    ...
    "Engulf_XAUUSD_tight_H4_lon": {
        "strat": "Engulf", "symbol": "XAUUSD", "tier": "SPREAD_OK", "pf": 1.13,
        "params": {'timeframe': 'H4', 'swing_zone_atr': 0.3, 'min_body_ratio': 0.7, 'tp_atr_mult': 3.0, 'session_start': 7, 'session_end': 16},
    },
    "Engulf_XAUUSD_tight_H4_ny": {
        "strat": "Engulf", "symbol": "XAUUSD", "tier": "SPREAD_OK", "pf": 1.13,
        "params": {'timeframe': 'H4', 'swing_zone_atr': 0.3, 'min_body_ratio': 0.7, 'tp_atr_mult': 3.0, 'session_start': 12, 'session_end': 21},
    },
    ...
    "RegVMR_XTIUSD_default_H1_lon": {
        "strat": "RegVMR", "symbol": "XTIUSD", "tier": "SPREAD_OK", "pf": 1.08,
        "params": {'timeframe': 'H1', 'session_start': 7, 'session_end': 16},
    },
    "RegVMR_XTIUSD_default_H1_ny": {
        "strat": "RegVMR", "symbol": "XTIUSD", "tier": "SPREAD_OK", "pf": 1.08,
        "params": {'timeframe': 'H1', 'session_start': 12, 'session_end': 21},
    },
    ...
    "MACross_XAUUSD_trend_H4_lon": {
        "strat": "MACross", "symbol": "XAUUSD", "tier": "SPREAD_OK", "pf": 1.83,
        "params": {'timeframe': 'H4', 'fast_period': 12, 'slow_period': 34, 'adx_min': 25, 'sl_atr_mult': 2.5, 'tp_atr_mult': 6.0, 'session_start': 7, 'session_end': 16},
    },
